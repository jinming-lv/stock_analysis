...
| 文档 | 内容 |
| --- | --- |
| [课程开发与项目反哺说明](course-development-control.md) | `v0.1.0` 真实讲解、`dev` 反哺、增量课程和主课件/授课副本规则 |
| [课程问题索引](course-issues.md) | 问题版本字段、当前版本处理、`dev` 状态、升级课件和专项报告入口 |
| [课程版本基线方案](course-version-baseline.md) | `v0.1.0 → v0.1.1 → v0.2.0` 累积式演进及课程版本、教学 ZIP、开发版本映射 |
| [AI 友好化改造清单](ai-readiness-roadmap.md) | AI 协作资产风险、分阶段改造路线和可复用脚本候选 |
| [文档缺口清单](documentation-gaps.md) | 当前覆盖、冲突、难检索信息与复现缺口 |
